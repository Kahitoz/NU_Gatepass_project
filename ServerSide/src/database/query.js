...
export const queries = {
  ...
  getHostelTowers:"SELECT distinct [mastertowername]FROM [gps_db].[gps_db].[gps_hostalgroups] where masterhostal_name=@hostel;",
  getAllWardens:"SELECT UM.name as warden_name ,UM.user_id FROM [gps_db].[gps_db].[gps_usersmaster] AS UM WHERE UM.role_id=2;",
  getAllottedTowersReport:"SELECT [mastertowername] ,[masterhostal_name] ,[warden_name],masterhostal_id FROM [gps_db].[gps_db].[gps_hostalgroups] order by masterhostal_name;",
