        ...
        <div>
          <div className={`${designs.d1}`}>
            <div className={`${designs.d2}`}>
              ...
              <h1 className={`${designs.d5}`}>Departure Time</h1>
                ...
                props.filterData.map((item, idx) => (
                    <div className={`${designs.d4}`} key={idx}>
                      ...
                      <h1 className={`${designs.d5}`}>
                        {moment(item.from_date).utc().format('YYYY-MM-DD')} <br />{' '}
                        {moment(item.from_time).utc().format('HH:mm:ss')}
                      </h1>
                      <h1 className={`${designs.d5}`}>
