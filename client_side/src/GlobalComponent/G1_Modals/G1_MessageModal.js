    ...
    return(
        <>
            <div className="fixed inset-0 z-50 flex items-center justify-center backdrop-blur">
                <div className="bg-background flex flex-col border border-black w-4/12 p-6 rounded-md items-center justify-center">
                    <h1 className="text-xl font-bold mb-4 text-center">{title}</h1>
                    <p className={"m-2  rounded-md w-full text-center "}>{message}</p>
