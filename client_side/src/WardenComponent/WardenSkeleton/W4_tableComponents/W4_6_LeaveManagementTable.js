...
import moment from "moment";
 ...
 const W4_6_LeaveManagementTable = ({data,setPendingRequests}) => {
          ...
          <div>
            <div className={`${designs.d1}`}>
              <div className={`${designs.d2}`}>
                ...
                <h1 className={`${designs.d5}`}>Departure {'(Actual)'}</h1>
                <h1 className={`${designs.d5}`}>Arrival {'(Actual)'}</h1>
                <h1 className={`${designs.d5}`}>Reason</h1>
...
export default W4_6_LeaveManagementTable;