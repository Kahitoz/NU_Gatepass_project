...
import Modal from "./Modal/ModalPending";
 ...
 const W4_4_VisitorTable = ({data,setPendingRequests}) => {
          ...
          <div>
            <div className={`${designs.d1}`}>
              ...
              <h1 className={`${designs.d5}`}>S.no</h1>
                ...
                <h1 className={`${designs.d5}`}>Requestetd On</h1>
                <h1 className={`${designs.d5}`}>Visitor Description</h1>
...
export default W4_4_VisitorTable;