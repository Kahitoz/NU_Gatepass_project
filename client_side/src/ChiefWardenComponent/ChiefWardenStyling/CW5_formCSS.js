...
const CW5_FormCSS = {
    "d1":"bg-Items_bg border border-black ms-2 me-2 rounded-lg py-4",
    ...
    "d9":"text-white",
    "d10":" flex justify-center",
    "d11":"bg-Items_bg rounded-lg flex-col w-auto sm:w-full",
    "d12":"bg-background p-3 rounded-lg  center sm:mt-20 sm:mb-20 sm:mr-40 sm:ml-40 ",
